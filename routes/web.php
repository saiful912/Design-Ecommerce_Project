...
//    Route::get('/product/create','backend\AdminProductsController@product_create')->name('admin.product.create');
    ...
    Route::post('/products/store', 'backend\AdminProductsController@product_store')->name('admin.product.store');
...
//        'backend\AdminCategoriesController@category_create')->name('admin.categories.create');
    ...
    Route::post('/categories/store', 'backend\AdminCategoriesController@category_store')->name('admin.category.store');
...
//    Route::get('/brands/create', 'backend\AdminBrandsController@brand_create')->name('admin.brands.create');
    ...
    Route::post('/brands/store', 'backend\AdminBrandsController@brand_store')->name('admin.brand.store');
